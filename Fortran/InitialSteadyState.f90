...
equmINITSS = EquilibriumType(	ra,rborr,rcapital,wage,netwage,KYratio,KNratio,mc,rb,tfp,&
pi,rnom,gap,bond,capital,labor,output,investment,govexp,taxrev,govbond,worldbond,labtax,borrwedge,rho,&
mpshock,prefshock,priceadjust,fundlev,elast,gam,fundbond,&
profit,dividend,divrate,lumptransfer,equity,caputil,deprec,tfpadj,illassetdrop)
statsINITSS = DistributionStatsType(Ea,Eb,Ec,Elabor,Ed,Ewage,Enetlabinc,Egrosslabinc,&
Enetprofinc,Egrossprofinc,Einc,Ehours,Enw,FRACa0,FRACa0close,FRACb0,FRACb0close,&
