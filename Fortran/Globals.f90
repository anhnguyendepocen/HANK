...
!OPTIONS GLOBALS
integer	:: Display, ReportNonMonotonicity,&
NoLaborSupply,LaborSupplySep,LaborSupplyGHH,EquilibriumR, CalibrateCostFunction,&
DoImpulseResponses,CalibrateDiscountRate,SaveCumPolicyFnsIRF,ComputeDiscountedMPC
integer	:: SolveStickyPriceTransition, FirmDiscountRate, ImposeEqumInCalibration
integer :: ComputeCumulativeMPC, ScaleDisutilityIdio,SaveTime1PolicyFns,&
DoPriceExperiments,DistributeProfitsInProportion,&
TaxHHProfitIncome
integer :: AdjGovBudgetConstraint,ConvergenceRelToOutput,AdjustProdGridFrisch
integer :: GovExpConstantFracOutput,GovBondResidualZeroWorld,&
PinKappa1ByKappa02,ImposeMaxHours,&
OneAssetNoCapital
...
real(8) :: Vtol,KFEtol,deltass,deltakfe,deltacumcon,nendtrans,deltatransvec(Ttransition),&
cumdeltatrans(Ttransition),toltransition,deltatransparam,deltatransmin,deltatransmax,&
adjfricshgridfrac
real(8) :: tolequmss,stepequmss,tolrho,stepstickytransK,stepstickytransB,stepstickytransRb,dVamin,dVbmin

!CALIBRATION OPTIONS
integer ::  EstimateKappa0, EstimateKappa1, EstimateKappa2, EstimateKappa3, EstimateKappa4,&
EstimateRho, EstimateBorrWedge,EstimateGamma
integer :: MatchMeanIll, MatchMedianIll, MatchP75Ill, MatchFracIll0, MatchMeanLiq,&
MatchFracIll0Liq0, MatchMedianLiq, MatchFracLiq0, MatchFracLiqNeg,MatchKYratio
...
real(8), dimension(:,:,:), allocatable		:: V,Vnew,u,gjoint,c,h,d,s,ccum1,&
ccum4,ccum2,dcum1,dcum4,dcum2,bdot,mpc,subeff1ass,&
subeff2ass,wealtheff1ass,wealtheff2ass
...
!PARAMETER GLOBALS
real(8)     :: rho,gam,utilcost,chi,frisch,blim,nbl,abl,prefshock,fundlev,fundbond,deathrate,&
meanlabeff,profdistfrac
real(8)     :: elast,alpha,deprec,alphatilde,theta,phitaylor,phifg,bondelast,borrwedge,mpshock,&
bondadjust,bondelastrelgdp
real(8) 	:: kappa0_d,kappa1_d,kappa2_d,kappa0_w,kappa1_w,kappa2_w,kappa3,&
kappa4_d,kappa4_w
real(8) 	:: dmin,taxincrstart,taxincrdecay,utilelast,utilelastalpha

!EQUILIBRIUM GLOBALS
real(8)     :: ra,rborr,rcapital,wage,netwage,KYratio,KNratio,mc,rb,tfp,pi,rnom,gap,bond,capital,&
labor,output,investment,govexp,taxrev,govbond,worldbond,profit,dividend,divrate,priceadjust,equity
real(8)     :: labtax,lumptransfer,lumptransferpc,ssdebttogdp,corptax,illassetdrop,caputil,tfpadj
integer 	:: neqmiter
logical		:: converged,initialSS

!STATISTICS GLOBALS
real(8) 	:: Ea,Eb,Ec,Elabor,Ed,Ewage,Enetlabinc,Egrosslabinc,&
Enetprofinc,Egrossprofinc,Einc,Ehours,&
Enw,EbN,EbP,Eadjcost
real(8) 	:: FRACa0,FRACa0close,FRACb0,FRACb0close,FRACb0a0,FRACb0aP,FRACbN,&
FRACnw0,FRACnw0close,FRACb0a0close
...
real(8)		:: targetMeanIll,targetMeanLiq,targetMedianIll,targetP75Ill,targetMedianLiq,targetFracIll0,&
targetFracLiq0,targetFracIll0Liq0,targetFracLiqNEG,targetKYratio
real(8)		:: modelMeanIll,modelMeanLiq,modelMedianIll,modelP75Ill,modelMedianLiq,modelFracIll0,&
modelFracLiq0,modelFracIll0Liq0,modelFracLiqNEG,modelKYratio
...
!SOLUTION TYPE
type SolutionType
	real(8), dimension(:,:,:), allocatable	:: V,c,s,h,d,u,gjoint,bdot,mpc,&
subeff1ass,subeff2ass,wealtheff1ass,wealtheff2ass
	real(8), dimension(:), allocatable 		:: gvec	
...
type EquilibriumType
	real(8)		:: ra,rborr,rcapital,wage,netwage,KYratio,KNratio,mc,rb,tfp,pi,rnom,gap,bond,capital,&
labor,output,investment,govexp,taxrev,govbond,worldbond,labtax,borrwedge,rho,mpshock,prefshock,&
...
type DistributionStatsType
	real(8) 	:: Ea,Eb,Ec,Elabor,Ed,Ewage,Enetlabinc,Egrosslabinc,Enetprofinc,Egrossprofinc,Einc,Ehours,&
Enw,FRACa0,FRACa0close,FRACb0,FRACb0close,FRACb0a0,FRACb0aP,FRACbN,FRACnw0,FRACnw0close,&
FRACb0a0close, &
					EbN,EbP,Eadjcost,PERCa(11),PERCb(11),&
PERCnw(11),PERCc(11),PERCinc(11),GINIa,GINIb,GINInw,&
GINIc,GINIinc, &
					Ea_nwQ(4),Eb_nwQ(4),Ec_nwQ(4),&
Einc_nwQ(4),Ea_incQ(4),Eb_incQ(4),Ec_incQ(4),Einc_incQ(4),&
Ec_bN,Ec_b0close,Ec_b0far	
end type
